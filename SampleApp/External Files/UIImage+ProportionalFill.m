...
{
    return [self imageToFitSize:fitSize method:resizeMethod ignoreScale:NO];
}
...
{
	return [self imageCroppedToFitSize:fitSize ignoreScale:NO];
}
...
{
	return [self imageScaledToFitSize:fitSize ignoreScale:NO];
}

- (UIImage *)imageScaledToFitSize:(CGSize)fitSize ignoreScale:(BOOL)ignoreScale
{
	return [self imageToFitSize:fitSize method:MGImageResizeScale ignoreScale:ignoreScale];
}

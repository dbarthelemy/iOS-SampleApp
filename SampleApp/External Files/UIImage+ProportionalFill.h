...
- (UIImage *)imageCroppedToFitSize:(CGSize)size ignoreScale:(BOOL)ignoreScale; // uses MGImageResizeCrop
- (UIImage *)imageScaledToFitSize:(CGSize)size ignoreScale:(BOOL)ignoreScale; // uses MGImageResizeScale
